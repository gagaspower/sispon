      ...
      <table id="table"
          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-flat btn-xs btn-info btn-space" onclick="window.location.href='<?php echo base_url('organisasi/delete/'.$row['id']);?> '"><i class="fa fa-pencil-square-o"></i> Edit</button>
                </td>
              </tr>
                 @endforeach
          </tbody>
