...
<div class="box-header with-border">
        <h3 class="box-title"><i class="ion ion-clipboard"></i> Tambah Menu</h3>
    </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="nama_menu" class="form-control" id="nama_menu" autocomplete="off">
                    </div>
                </div>
                <div class="form-group">
                    <label for="nama" class="col-sm-2 control-label">Link Menu</label>
                    <div class="col-sm-4">
                      <input type="text" name="link_menu" class="form-control" id="link_menu" autocomplete="off">
                    </div>
                </div>
                <div class="form-group">
                    <label for="nama" class="col-sm-2 control-label">Icon Menu</label>
                    <div class="col-sm-4">
                      <input type="text" name="icon_menu" class="form-control" id="icon_menu" autocomplete="off">
                    </div>
                </div>
                <div class="form-group">
...
<script>
            $("#simpan_menu").click(function () {
              ...
              if( "" == role){
                ...
                $.ajax({
                    url:'<?php echo base_url();?>menu/store',
                    data: {
                        nama : nama,
                        link : link,
                        icon : icon,
